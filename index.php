...
<body>
    ...
    <main class="container-fluid mt-3">
        ...
        <?php foreach ($titles as $title) { ?>
                <div class="col-sm-3">
                <a href="http://localhost/btth01/detail.php?id=<?php echo $title['ma_bviet']; ?>">
                    <div class="card mb-2" style="width: 100%;">
                        <img src="images/songs/<?php echo $title['hinhanh']; ?>.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title text-center">
                                <a href="" class="text-decoration-none"><?php echo $title['tieude']; ?></a>
                            </h5>
                        </div>
                    </div>
                </div>
