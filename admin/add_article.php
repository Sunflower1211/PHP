        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="process_add_article.php" method="post">
                    ...
                    <select id="lblCatName" name="txtCategoryName" class="form-control" required>
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <textarea id="multilineInput" name="txtSummaryName" rows="4" cols="170"></textarea>
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tác giả</span>
                        <select id="lblCatName" name="txtAuthorName" class="form-control" required>
                            <option value="default" selected>Chọn tác giả</option>
